...
export const SettingsIcon: React.FC<IconProps> = (props) => (
    <svg {...props} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor">
      <path strokeLinecap="round" strokeLinejoin="round" d="M9.594 3.94c.09-.542.56-1.007 1.11-1.212.55-.205 1.18-.205 1.73 0 .55.205 1.02.67 1.11 1.212.09.542-.217 1.077-.754 1.424l-.383.256a1.815 1.815 0 0 1-2.44 0l-.383-.256a1.125 1.125 0 0 1-.754-1.424Z" />
      <path strokeLinecap="round" strokeLinejoin="round" d="M12 15.75a3.75 3.75 0 1 0 0-7.5 3.75 3.75 0 0 0 0 7.5Z" />
      <path strokeLinecap="round" strokeLinejoin="round" d="M13.5 1.5v2.25m-.75-2.25h1.5m-1.5 18v2.25m-.75-2.25h1.5m-6-15v2.25m-.75-2.25h1.5m-1.5 18v2.25m-.75-2.25h1.5m12-6.75v-1.5m2.25.75h-2.25m-18 0h-2.25m2.25.75v-1.5m18 0v-1.5m-2.25.75h-2.25" />
    </svg>
);

export const CopyIcon: React.FC<IconProps> = (props) => (
  <svg {...props} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor">
    <path strokeLinecap="round" strokeLinejoin="round" d="M15.75 17.25v3.375c0 .621-.504 1.125-1.125 1.125h-9.75c-.621 0-1.125-.504-1.125-1.125V7.875c0-.621.504-1.125 1.125-1.125H6.75a9.06 9.06 0 0 1 1.5.124m7.5 10.376h3.375c.621 0 1.125-.504 1.125-1.125V11.25c0-4.46-3.243-8.161-7.5-8.876a9.06 9.06 0 0 0-1.5-.124H9.375c-.621 0-1.125.504-1.125 1.125v3.5m7.5 10.375H9.375a2.25 2.25 0 0 1-2.25-2.25v-9.75m10.5 12v-9.75c0-.621-.504-1.125-1.125-1.125H9.375c-.621 0-1.125.504-1.125-1.125v-1.5c0-.621.504-1.125 1.125-1.125h3.375c4.257 0 7.5 3.342 7.5 7.5v1.5c0 .621-.504 1.125-1.125 1.125Z" />
  </svg>
);
...
export const ImageIcon: React.FC<IconProps> = (props) => (
  <svg {...props} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor">
    <path strokeLinecap="round" strokeLinejoin="round" d="m2.25 15.75 5.159-5.159a2.25 2.25 0 0 1 3.182 0l5.159 5.159m-1.5-1.5 1.409-1.409a2.25 2.25 0 0 1 3.182 0l2.909 2.909m-18 3.75h16.5a1.5 1.5 0 0 0 1.5-1.5V6a1.5 1.5 0 0 0-1.5-1.5H3.75A1.5 1.5 0 0 0 2.25 6v12a1.5 1.5 0 0 0 1.5 1.5Zm16.5-16.5h.008v.008h-.008v-.008Z" />
  </svg>
);
...
export const YouTubeIcon: React.FC<IconProps> = (props) => (
  <svg {...props} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor">
    <path strokeLinecap="round" strokeLinejoin="round" d="M21.75 6.75a2.25 2.25 0 0 0-2.25-2.25H4.5A2.25 2.25 0 0 0 2.25 6.75v10.5A2.25 2.25 0 0 0 4.5 19.5h15a2.25 2.25 0 0 0 2.25-2.25V6.75Z" />
    <path strokeLinecap="round" strokeLinejoin="round" d="m9.75 15.375 6-3.375-6-3.375v6.75Z" />
  </svg>
);
...
export const RecordingIcon: React.FC<IconProps> = (props) => (
    <svg {...props} viewBox="0 0 8 24" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
...
export const RefreshIcon: React.FC<IconProps> = (props) => (
  <svg {...props} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
    <path strokeLinecap="round" strokeLinejoin="round" d="M16.023 9.348A4.992 4.992 0 0 1 19.5 12c0 2.761-2.239 5-5 5s-5-2.239-5-5 2.239-5 5-5a4.992 4.992 0 0 1 3.348 1.274L15 6" />
    <path strokeLinecap="round" strokeLinejoin="round" d="M15 9h4.5V4.5" />
  </svg>
);

export const ThumbsUpIcon: React.FC<IconProps> = (props) => (
  <svg {...props} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor">
    <path strokeLinecap="round" strokeLinejoin="round" d="M6.633 10.5c.806 0 1.533-.446 2.031-1.08a9.041 9.041 0 0 1 2.861-2.4c.723-.384 1.35-.956 1.653-1.715a4.498 4.498 0 0 0 .322-1.672V3a.75.75 0 0 1 .75-.75A2.25 2.25 0 0 1 16.5 4.5c0 1.152-.26 2.243-.723 3.218-.266.558.107 1.282.725 1.282h3.126c1.026 0 1.945.694 2.054 1.715.045.422.068.85.068 1.285a11.95 11.95 0 0 1-2.148 7.25c-.246.354-.582.662-.956.918A7.486 7.486 0 0 1 15.75 21a8.962 8.962 0 0 1-5.905-1.952 8.962 8.962 0 0 1-1.332-1.152A9.041 9.041 0 0 0 6.633 10.5zM4 14.25a.75.75 0 0 0 .75.75h.008a.75.75 0 0 0 .75-.75v-8.25a.75.75 0 0 0-.75-.75h-.008a.75.75 0 0 0-.75.75v8.25z" />
  </svg>
);

export const ThumbsDownIcon: React.FC<IconProps> = (props) => (
  <svg {...props} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor">
    <path strokeLinecap="round" strokeLinejoin="round" d="M17.367 13.5c-.806 0-1.533.446-2.031 1.08a9.041 9.041 0 0 1-2.861 2.4c-.723.384-1.35.956-1.653 1.715a4.498 4.498 0 0 0-.322 1.672V21a.75.75 0 0 1-.75.75A2.25 2.25 0 0 1 7.5 19.5c0-1.152.26-2.243.723-3.218.266-.558-.107-1.282-.725-1.282H4.375c-1.026 0-1.945-.694-2.054-1.715-.045-.422-.068-.85-.068-1.285a11.95 11.95 0 0 1 2.148-7.25c.246-.354.582.662-.956.918A7.486 7.486 0 0 1 8.25 3a8.962 8.962 0 0 1 5.905 1.952 8.962 8.962 0 0 1 1.332 1.152A9.041 9.041 0 0 0 17.367 10.5zM20 9.75a.75.75 0 0 0-.75-.75h-.008a.75.75 0 0 0-.75.75v8.25a.75.75 0 0 0 .75.75h.008a.75.75 0 0 0 .75-.75v-8.25z" />
  </svg>
);
...
export const FitToScreenIcon: React.FC<IconProps> = (props) => (
    <svg {...props} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
        <path strokeLinecap="round" strokeLinejoin="round" d="M4.5 20.25l3.75-3.75m0 0V20.25m0-3.75H4.5m15-7.5l-3.75 3.75m0 0V3.75m0 3.75h3.75M4.5 3.75l3.75 3.75M8.25 3.75H4.5v3.75m15 12.75l-3.75-3.75m0 0h3.75m-3.75 0v3.75" />
    </svg>
);